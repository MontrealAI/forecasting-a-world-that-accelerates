...
- METR probabilistic rolling-origin scorecard: 6 frozen one-step origins.
- Full model average mean CRPS: **45.812**.
- Full model average mean WIS: **138.099**.
- Accelerating-only log-RMSE: **0.2846**.
- Controlled workflow critical path: **13.26 hours**.

## Validation ladder

- **L1 mechanical:** supplied
- **L2 controlled mechanism:** supplied
- **L3 source linked historical:** supplied with limitations
- **L4 preregistered prospective:** infrastructure supplied; outcomes pending
